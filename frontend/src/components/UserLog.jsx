    ...
    <div>
        ...
        <div className=''>
            {data?.users?.map((val,key)=>(
                <div key={key} className='flex flex-col sm:flex-row sm:justify-between bg-gray-100 px-3 py-2 items-center rounded-xl shadow-md mb-4'>
                <div>
                  <h2>{val?.name}</h2>
                  <h2>{val?.email}</h2>
                ...
                <div className='flex sm:flex sm:flex-col gap-2'>
